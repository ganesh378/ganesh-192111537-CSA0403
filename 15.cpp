...
snprintf(dest_file, sizeof(dest_file), "%s/level%d/%s", dest_dir, (entry->d_name[4] - '0'), entry->d_name); // Changed (entry->d_name[0] - '0') to (entry->d_name[4] - '0') to extract the file number correctly
